...
# - substitutions should not contain '|' character (because we sue sed rules
...
text_tpl_gen_conv="\$(AM_V_GEN)rm -rf \@S|@@; \$(MKDIR_P) \$(@D)"

# Instantiate arbitrary data text file
text_tpl_gen="\$(text_tpl_gen_conv) && \$(__ax_text_tpl_sed_call) \$< > \@S|@@ && chmod -w \@S|@@"

# Instantiate script file
text_tpl_gen_script="\$(text_tpl_gen) && chmod +x \@S|@@"
